...
class TripValidation
{
    ...
    public function getEmployeeValidation(): ?string
    {
        return $this->employee_validation;
    }

    public function setEmployeeValidation(string $employee_validation): static
    {
        $this->employee_validation = $employee_validation;
